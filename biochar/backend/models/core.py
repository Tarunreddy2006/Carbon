...
class Evidence(Base):
    ...
    bucket_name: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    object_key: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    storage_provider: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    sha256_hash: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    upload_status: Mapped[str] = mapped_column(Text, default="Pending", server_default=text("'Pending'"))
